...
const String sheet_url = "https://script.google.com/macros/s/Your Google ScriptLink/exec?name=";  //Enter Google Script URL
...
//-----------------------------------------
#define WIFI_SSID "xxxxxxxxx"  //Enter WiFi Name
#define WIFI_PASSWORD "xxxxxxxxxxx"  //Enter WiFi Password
//-----------------------------------------
